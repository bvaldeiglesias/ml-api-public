...
def classify_process():
    ...
    while True:
        ...
        for q in queue:
            ...
            #
            ##############################################################
            data = json.loads(q.decode('utf-8'))

            prediction, score = predict(data["text"])

            result = {"prediction": prediction, "score": score}
